...
const CATEGORIES = ['Feature-Wunsch', 'Bug', 'Design', 'Performance', 'Sonstiges']
  ...
  return (
    <>
      ...
      >
        ...
        <span className="hidden sm:inline">Feedback & Wünsche</span>
      </button>
        ...
        >
          <div className="w-full max-w-md overflow-hidden rounded-t-2xl bg-background sm:rounded-2xl">
            ...
            <div className="flex items-center justify-between border-b px-5 py-4">
              <span className="font-semibold text-foreground">Feedback & Wünsche</span>
              <button
            ...
            <div className="max-h-[75dvh] overflow-y-auto px-5 py-4">
              {submitted ? (
                <div className="py-10 text-center">
                  ...
                  <p className="font-semibold text-green-600">Danke für dein Feedback!</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <input
                      required
                      placeholder="z.B. Exportfunktion für Mieter"
                      value={form.title}
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      required
                      rows={3}
                      placeholder="Was genau wünschst du dir, oder was stimmt nicht?"
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-muted-foreground">E-Mail (optional)</label>
                    <input
                      type="email"
                      value={form.email}
